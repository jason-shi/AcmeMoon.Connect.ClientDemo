    ...
    public class SignInBehavior : MonoBehaviour {
        ...
        private async Task SignIn()
        {
            Debug.Log("SignInBehavior::Signing in...");
             var siginErrCode = await _authClient.LoginAsync();
            _signedIn = String.IsNullOrEmpty(siginErrCode);
            ...
            if (_signedIn)
            {
                StatusText.GetComponent<Text>().text = "Hello " + _authClient.GetUserName() + " IdentityToken: " + _authClient.GetIdentityToken();
            }
            ...
            else
            {
                ...
                StatusText.GetComponent<Text>().text = siginErrCode;
            }
        }
